...
from voc_dataset import VOCDetection,collate_fn,IMG_SIZE


parser = argparse.ArgumentParser()
parser.add_argument("--model_dir",default='checkpoints',type=str)
parser.add_argument("--data_dir",default='data_voc',type=str)
...
trainval_07 = VOCDetection(DATA_DIR,image_set='trainval',year='2007',transforms=transforms)
trainval_12 = VOCDetection(DATA_DIR,image_set='trainval',year='2012',transforms=transforms)
train_dataset = torch.utils.data.ConcatDataset([trainval_07,trainval_12])
